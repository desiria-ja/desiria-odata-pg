CREATE SCHEMA IF NOT EXISTS "odk_stage";

CREATE TABLE IF NOT EXISTS "odk_stage"."bird_survey" (
...
CREATE TABLE IF NOT EXISTS "odk_stage"."odk_sync_state" (
...
INSERT INTO "odk_stage"."bird_survey" ("__id", "__system_submissionDate", "__system_submitterId", "count", "location", "notes_field", "photo", "species")
...
INSERT INTO "odk_stage"."odk_sync_state" ("table_name", "row_count", "next_link", "updated_at")
